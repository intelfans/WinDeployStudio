...
/// present in the bundled image catalog. It deliberately does not treat an
/// unknown image or an I/O error as a failed validation.
class KnownIsoVerificationService {
  ...
  Future<_FileDigests?> _readDigests(String filePath) async {
    try {
      ...
      return _FileDigests(sha256: sha256, md5: md5);
    } catch (_) {
      return null;
    }
  }
