...
const _en = <String, String>{
  ...
  'home_wtg_desc': 'Create portable Windows To Go or Linux live workspaces',
...
const _zh = <String, String>{
  ...
  'home_wtg': 'To Go 工作空间',
  'home_wtg_desc': '创建便携式 Windows To Go 或 Linux Live 工作环境',
...
const _ru = <String, String>{
  ...
  'home_wtg_desc': 'Создавайте переносные среды Windows To Go или Linux Live',
...
const _fr = <String, String>{
  ...
  'home_wtg_desc': 'Créer des espaces Windows To Go ou Linux Live portables',
...
const _ja = <String, String>{
  ...
  'home_wtg_desc': 'ポータブルな Windows To Go または Linux Live 環境を作成',
...
const _zhTW = <String, String>{
  ...
  'home_wtg': 'To Go 工作空間',
  'home_wtg_desc': '建立攜帶式 Windows To Go 或 Linux Live 工作環境',
...
const _es = <String, String>{
  ...
  'home_wtg_desc': 'Crea espacios portátiles Windows To Go o Linux Live',
...
const _ar = <String, String>{
  ...
  'home_wtg_desc': 'إنشاء بيئات Windows To Go أو Linux Live محمولة',
...
const _pt = <String, String>{
  ...
  'home_wtg_desc': 'Crie ambientes portáteis Windows To Go ou Linux Live',
  'home_local_iso': 'Importar ISO local',
...
const _de = <String, String>{
  ...
  'home_wtg_desc':
      'Portable Windows To Go- oder Linux Live-Arbeitsumgebungen erstellen',
...
const _ko = <String, String>{
  ...
  'home_wtg_desc': '휴대용 Windows To Go 또는 Linux Live 작업 환경 만들기',
