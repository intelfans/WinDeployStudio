                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text(tr(context, 'copied')), duration: const Duration(seconds: 1)),
                        );
                      },
    ...
    return Row(
      ...
      children: [
        ...
        const SizedBox(width: 8),
                    Text(tr(context, 'ai_thinking'), style: TextStyle(fontSize: 13, color: colorScheme.onSurfaceVariant)),
      ],
    );
  }
  ...
  Widget _buildContent(BuildContext context, ColorScheme colorScheme) {
    return MarkdownBody(
      ...
      styleSheet: MarkdownStyleSheet(
        ...
        tableHead: TextStyle(fontWeight: FontWeight.w600, color: colorScheme.onSurface),
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 4),
              Text(tr(context, 'ai_sources'), style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: colorScheme.primary)),
            ],
          ),
          const SizedBox(height: 8),
          ...sources.map((s) => Padding(
                ...
                child: GestureDetector(
                  onTap: () {
                    final ctx = context;
                    if (ctx.mounted) WebviewHelper.openUrl(ctx, s['url']!, title: s['title']);
                  },
                  child: Text(
