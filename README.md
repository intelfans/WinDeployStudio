...
| Home | Windows To Go | Bootable Media |
|:---:|:---:|:---:|
| ![Home](screenshots/1.png) | ![WTG](screenshots/2.png) | ![Creator](screenshots/3.png) |

| Image Center | Toolbox | Logs |
|:---:|:---:|:---:|
| ![Mirror](screenshots/4.png) | ![Toolbox](screenshots/5.png) | ![Logs](screenshots/6.png) |

| AI Assistant | Settings | Languages |
|:---:|:---:|:---:|
| ![AI](screenshots/7.png) | ![Settings](screenshots/8.png) | ![Languages](screenshots/9.png) |
...
WinDeploy Studio 是一个基于 Flutter 开发的现代化 Windows 部署工具。它将 Windows 安装盘制作、Windows To Go、镜像中心、工具箱、日志中心以及 AI 助手整合到统一界面中。

### 截图

| 首页 | Windows To Go | 启动盘制作 |
|:---:|:---:|:---:|
| ![首页](screenshots/1.png) | ![WTG](screenshots/2.png) | ![制作](screenshots/3.png) |

| 镜像中心 | 工具箱 | 日志中心 |
|:---:|:---:|:---:|
| ![镜像](screenshots/4.png) | ![工具](screenshots/5.png) | ![日志](screenshots/6.png) |

| AI 助手 | 设置 | 多语言 |
|:---:|:---:|:---:|
| ![AI](screenshots/7.png) | ![设置](screenshots/8.png) | ![语言](screenshots/9.png) |
...
- ISO 自动解析（install.wim / install.esd）
- 多版本镜像选择
- 自动格式化并创建启动盘
...
#### 🧰 工具箱
系统部署、磁盘工具、硬件检测、网络工具、系统优化、系统救援、文件工具。

#### 🤖 AI 助手
- 基于 Mimo-V2.5-Pro
- AI 对话、联网搜索、日志分析、故障诊断
...
本项目仅用于合法的系统部署、学习与维护用途。Windows、Microsoft、Intel 及其相关名称、商标、Logo 均归其各自权利人所有。本项目与 Microsoft Corporation、Intel Corporation 不存在任何官方关联关系。

---

## 繁體中文

WinDeploy Studio 是一個基於 Flutter 開發的現代化 Windows 部署工具。它將 Windows 安裝盤製作、Windows To Go、鏡像中心、工具箱、日誌中心以及 AI 助手整合到統一介面中。

### 截圖

| 首頁 | Windows To Go | 啟動盤製作 |
|:---:|:---:|:---:|
| ![首頁](screenshots/1.png) | ![WTG](screenshots/2.png) | ![製作](screenshots/3.png) |

| 鏡像中心 | 工具箱 | 日誌中心 |
|:---:|:---:|:---:|
| ![鏡像](screenshots/4.png) | ![工具](screenshots/5.png) | ![日誌](screenshots/6.png) |

| AI 助手 | 設定 | 多語言 |
|:---:|:---:|:---:|
| ![AI](screenshots/7.png) | ![設定](screenshots/8.png) | ![語言](screenshots/9.png) |
...
- ISO 自動解析（install.wim / install.esd）
- 多版本鏡像選擇
- 自動格式化並建立啟動盤
...
#### 🧰 工具箱
系統部署、磁碟工具、硬體偵測、網路工具、系統最佳化、系統救援、檔案工具。

#### 🤖 AI 助手
- 基於 Mimo-V2.5-Pro
- AI 對話、聯網搜尋、日誌分析、故障診斷
...
#### 🎨 個人化
深色模式、Intel Blue 主題、自訂主題顏色、HarmonyOS Sans、微軟雅黑。
...
本專案僅用於合法的系統部署、學習與維護用途。Windows、Microsoft、Intel 及其相關名稱、商標、Logo 均歸其各自權利人所有。本專案與 Microsoft Corporation、Intel Corporation 不存在任何官方關聯關係。

---

## 日本語

WinDeploy Studio は Flutter で開発されたモダンな Windows デプロイメントツールです。Windows インストールメディア作成、Windows To Go、イメージセンター、ツールボックス、ログセンター、AI アシスタントを統合インターフェースにまとめています。

### スクリーンショット

| ホーム | Windows To Go | インストールメディア |
|:---:|:---:|:---:|
| ![ホーム](screenshots/1.png) | ![WTG](screenshots/2.png) | ![作成](screenshots/3.png) |

| イメージセンター | ツールボックス | ログセンター |
|:---:|:---:|:---:|
| ![イメージ](screenshots/4.png) | ![ツール](screenshots/5.png) | ![ログ](screenshots/6.png) |

| AI アシスタント | 設定 | 多言語 |
|:---:|:---:|:---:|
| ![AI](screenshots/7.png) | ![設定](screenshots/8.png) | ![言語](screenshots/9.png) |
...
- ワンクリック作成
- ディスク互換性自動検出
- 容量 / バスタイプ / USB バージョン解析
- GPT / UEFI 対応

#### 📦 イメージセンター
- Windows イメージナビゲーション内蔵
- 自動地域ミラー切換
- アプリ内ブラウジングとダウンロード

#### 🧰 ツールボックス
システムデプロイメント、ディスクユーティリティ、ハードウェア検出、ネットワークツール、システム最適化、システムレスキュー、ファイルツール。

#### 🤖 AI アシスタント
- Mimo-V2.5-Pro ベース
- チャット、Web 検索、ログ分析、故障診断

#### 📋 ログセンター
- USB / ISO / ダウンロード / アップデート / エラー / AI ログ
- カテゴリ表示、クイックロケート、ワンクリックフォルダ開封

#### 🌍 多言語
11 言語対応：簡体中国語、繁体中国語、英語、日本語、韓国語、ドイツ語、フランス語、スペイン語、ポルトガル語、ロシア語、アラビア語。

#### 🎨 パーソナライゼーション
ダークモード、Intel Blue テーマ、カスタムカラー、HarmonyOS Sans、Microsoft YaHei。
...
本プロジェクトは合法的なシステムデプロイメント、学習、メンテナンス目的のみに使用されます。Windows、Microsoft、Intel および関連する名前、商標、ロゴはそれぞれの所有者に帰属します。本プロジェクトは Microsoft Corporation、Intel Corporation との公式な関係はありません。

---

## 한국어

WinDeploy Studio는 Flutter로 개발된 현대적인 Windows 배포 도구입니다. Windows 설치 미디어 생성, Windows To Go, 이미지 센터, 도구 상자, 로그 센터, AI 어시스턴트를 통합 인터페이스에 결합합니다.

### 스크린샷

| 홈 | Windows To Go | 설치 미디어 |
|:---:|:---:|:---:|
| ![홈](screenshots/1.png) | ![WTG](screenshots/2.png) | ![생성](screenshots/3.png) |

| 이미지 센터 | 도구 상자 | 로그 센터 |
|:---:|:---:|:---:|
| ![이미지](screenshots/4.png) | ![도구](screenshots/5.png) | ![로그](screenshots/6.png) |

| AI 어시스턴트 | 설정 | 다국어 |
|:---:|:---:|:---:|
| ![AI](screenshots/7.png) | ![설정](screenshots/8.png) | ![언어](screenshots/9.png) |
...
- ISO 자동 분석 (install.wim / install.esd)
- 다중 버전 이미지 선택
- 자동 포맷 및 부팅 미디어 생성
...
#### 📦 이미지 센터
- Windows 이미지 내비게이션 내장
- 자동 지역 미러 전환
- 앱 내 브라우징 및 다운로드

#### 🧰 도구 상자
시스템 배포, 디스크 유틸리티, 하드웨어 감지, 네트워크 도구, 시스템 최적화, 시스템 복구, 파일 도구.
...
- 카테고리 보기, 빠른 찾기, 원클릭 폴더 열기

#### 🌍 다국어
11개 언어 지원: 간체 중국어, 번체 중국어, 영어, 일본어, 한국어, 독일어, 프랑스어, 스페인어, 포르투갈어, 러시아어, 아랍어.

#### 🎨 개인화
다크 모드, Intel Blue 테마, 사용자 정의 색상, HarmonyOS Sans, Microsoft YaHei.
...
본 프로젝트는 합법적인 시스템 배포, 학습 및 유지보수 목적으로만 사용됩니다. Windows, Microsoft, Intel 및 관련 이름, 상표, 로고는 해당 소유자에게 귀속됩니다. 본 프로젝트는 Microsoft Corporation, Intel Corporation과 공식적인 관계가 없습니다.
...
| Startseite | Windows To Go | Installationsmedien |
|:---:|:---:|:---:|
| ![Startseite](screenshots/1.png) | ![WTG](screenshots/2.png) | ![Erstellung](screenshots/3.png) |

| Image-Center | Toolbox | Log-Center |
|:---:|:---:|:---:|
| ![Image](screenshots/4.png) | ![Toolbox](screenshots/5.png) | ![Logs](screenshots/6.png) |

| KI-Assistent | Einstellungen | Mehrsprachig |
|:---:|:---:|:---:|
| ![KI](screenshots/7.png) | ![Einstellungen](screenshots/8.png) | ![Sprachen](screenshots/9.png) |
...
| Accueil | Windows To Go | Supports d'installation |
|:---:|:---:|:---:|
| ![Accueil](screenshots/1.png) | ![WTG](screenshots/2.png) | ![Création](screenshots/3.png) |

| Centre d'images | Boîte à outils | Centre de journaux |
|:---:|:---:|:---:|
| ![Images](screenshots/4.png) | ![Outils](screenshots/5.png) | ![Journaux](screenshots/6.png) |

| Assistant IA | Paramètres | Multilangue |
|:---:|:---:|:---:|
| ![IA](screenshots/7.png) | ![Paramètres](screenshots/8.png) | ![Langues](screenshots/9.png) |
...
| Inicio | Windows To Go | Medios de instalación |
|:---:|:---:|:---:|
| ![Inicio](screenshots/1.png) | ![WTG](screenshots/2.png) | ![Creación](screenshots/3.png) |

| Centro de imágenes | Caja de herramientas | Centro de registros |
|:---:|:---:|:---:|
| ![Imágenes](screenshots/4.png) | ![Herramientas](screenshots/5.png) | ![Registros](screenshots/6.png) |

| Asistente IA | Configuración | Multilingüe |
|:---:|:---:|:---:|
| ![IA](screenshots/7.png) | ![Configuración](screenshots/8.png) | ![Idiomas](screenshots/9.png) |
...
| Início | Windows To Go | Mídia de instalação |
|:---:|:---:|:---:|
| ![Início](screenshots/1.png) | ![WTG](screenshots/2.png) | ![Criação](screenshots/3.png) |

| Centro de imagens | Caixa de ferramentas | Centro de logs |
|:---:|:---:|:---:|
| ![Imagens](screenshots/4.png) | ![Ferramentas](screenshots/5.png) | ![Logs](screenshots/6.png) |

| Assistente IA | Configurações | Multilíngue |
|:---:|:---:|:---:|
| ![IA](screenshots/7.png) | ![Configurações](screenshots/8.png) | ![Idiomas](screenshots/9.png) |
...
| Главная | Windows To Go | Установочные носители |
|:---:|:---:|:---:|
| ![Главная](screenshots/1.png) | ![WTG](screenshots/2.png) | ![Создание](screenshots/3.png) |

| Центр образов | Набор инструментов | Центр журналов |
|:---:|:---:|:---:|
| ![Образы](screenshots/4.png) | ![Инструменты](screenshots/5.png) | ![Журналы](screenshots/6.png) |

| AI-ассистент | Настройки | Мультиязычность |
|:---:|:---:|:---:|
| ![AI](screenshots/7.png) | ![Настройки](screenshots/8.png) | ![Языки](screenshots/9.png) |
...
| الرئيسية | Windows To Go | وسائط التثبيت |
|:---:|:---:|:---:|
| ![الرئيسية](screenshots/1.png) | ![WTG](screenshots/2.png) | ![الإنشاء](screenshots/3.png) |

| مركز الصور | صندوق الأدوات | مركز السجلات |
|:---:|:---:|:---:|
| ![الصور](screenshots/4.png) | ![الأدوات](screenshots/5.png) | ![السجلات](screenshots/6.png) |

| مساعد الذكاء الاصطناعي | الإعدادات | متعدد اللغات |
|:---:|:---:|:---:|
| ![الذكاء الاصطناعي](screenshots/7.png) | ![الإعدادات](screenshots/8.png) | ![اللغات](screenshots/9.png) |
