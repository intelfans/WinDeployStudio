...
- **镜像中心**
  - 区分 **Official Microsoft Images**、**Community Editions** 与 **Enterprise & LTSC Builds**。
...
<table>
  <tr>
    <td width="33%"><img src="screenshots/3.png" alt="镜像分类"><br><sub><b>3. 来源分类</b> - 将 Microsoft 官方镜像、社区版本和 Enterprise/LTSC 构建分组显示，来源更清楚。</sub></td>
...
AI 助手用于部署问答、排障建议和日志分析。界面包含明确的 AI 内容提示，并支持自定义 OpenAI-compatible 代理端点，适合使用自建代理或兼容服务的用户。
...
<table>
  <tr>
    <td><img src="screenshots/13.png" alt="工具箱"><br><sub><b>13. 工具卡片</b> - 浏览精选工具，查看开发者和来源信息，并在打开前识别 Beginner、Advanced 或 Expert 安全等级。</sub></td>
  </tr>
</table>
