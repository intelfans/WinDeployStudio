(() => {
  ...
  const translations = {
    zh: {
      ...
      download_band_title: "从 GitHub Releases 获取可信安装包",
      ...
      history_title: "历史版本",
      release_loading: "正在读取 GitHub Releases...",
      ...
      images_copy: "参考应用内的镜像中心，按来源、用途和风险级别查看镜像。具体下载映射将在 SourceForge 文件目录完成后启用。",
      catalog_eyebrow: "镜像库",
      ...
      image_download_sources: "下载来源",
      image_placeholder_title: "下载映射准备中",
      image_placeholder_copy: "该镜像的 SourceForge 文件链接尚未配置，发布后此处会直接开始下载。",
      image_close: "关闭",
      level_beginner: "入门",
      level_advanced: "高级",
      level_expert: "专家",
    ...
    en: {
      ...
      download_band_title: "Get verified installers from GitHub Releases",
      ...
      release_loading: "Loading GitHub Releases...",
      ...
      images_copy: "Like the application Image Center, browse by source, purpose, and suitability level. SourceForge mappings will be enabled once the file directory is ready.",
      ...
      image_download_sources: "Download sources",
      image_placeholder_title: "Download mapping pending",
      image_placeholder_copy: "The SourceForge file link for this image is not configured yet. This action will download directly once it is published.",
      image_close: "Close",
