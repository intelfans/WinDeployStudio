...
| 文件 | 字段 | 当前值 |
| --- | --- | --- |
| `pubspec.yaml` | `version` | `1.1.2` |
| `lib/core/constants/app_constants.dart` | `appVersion` | `1.1.2` |
| `installer/windows/WinDeployStudio.iss` | 安装包版本字段 | 应与 `1.1.2` 同步 |
| `scripts/build_installer.ps1` | 输出安装包名 | 应与 `1.1.2` 同步 |
